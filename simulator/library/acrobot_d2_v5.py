...
class AcrobotEnv_d2(core.Env):
    ...
    **REFERENCE:**
    ...
    LINK_MASS_2 = 0.32  #: [kg] mass of link 2
    LINK_COM_POS_1 = 0.226528  #: [m] position of the center of mass of link 1
    LINK_COM_POS_2 = 0.0732  #: [m] position of the center of mass of link 2
    LINK_MOI1 = 0.089616835  #: [kg m^2] moments of inertia for both links
    LINK_MOI2 = 0.001935402  #: [kg m^2] moments of inertia for both links
    ...
    def step(self, dir):
        ...
        ns[1] = bound(ns[1], self.low[1], self.high[1])
        ns[2] = bound(ns[2], self.low[2], self.high[2])
        ns[3] = bound(ns[3], self.low[3], self.high[3])
        self.state = ns
